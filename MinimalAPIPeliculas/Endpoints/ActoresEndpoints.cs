...
namespace MinimalAPIPeliculas.Endpoints
{
    public static class ActoresEndpoints
    {
        ...
        public static RouteGroupBuilder MapActores(this RouteGroupBuilder group)
        {
            ...
            //Colocamos DisableAntiforgery() para poder utilizar el FromForm
            ...
            IMapper mapper)
        {
            ...
            //Mappear de CrearActorDTO a Actor
            var actorActualizar = mapper.Map<Actor>(crearActorDTO);
            actorActualizar.Id = id;
            actorActualizar.Foto = actorDB.Foto;

            if (crearActorDTO.Foto is not null)
            {
                var url = await almacenadorArchivos.Editar(actorActualizar.Foto, contenedor, crearActorDTO.Foto);
